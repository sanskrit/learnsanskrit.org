    ...
    def __init__(self, from_scheme, to_scheme):
        ...
        for group in from_scheme:
            if group not in to_scheme:
                continue
            sub_map = {k: v for (k, v) in zip(from_scheme[group], to_scheme[group])}
    ...
    SCHEMES.update(
        {
            ...
            HK: Scheme(
                {
                    "vowels": s("""a A i I u U R RR L LL e ai o au"""),
                    "marks": s("""A i I u U R RR L LL e ai o au"""),
                    "virama": [""],
                    "other": s("M H ~"),
                    "consonants": s(
                        """
            ...
            KOLKATA: Scheme(
                {
                    "vowels": s("""a ā i ī u ū r̥ r̥̄ l̥ l̥̄ ē ai ō au"""),
                    "marks": s("""ā i ī u ū r̥ r̥̄ l̥ l̥̄ ē ai ō au"""),
                    "virama": [""],
                    "other": s("ṁ ḥ \u0310"),
                    "consonants": s(
                        """
